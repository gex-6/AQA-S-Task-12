    ...
    public void yakabooTests() throws InterruptedException {
        ...
        if (noBookButton.exists()) {
            ...
            if (paperBookButton.isDisplayed()) {
                String pricePaper = Selenide.$("div.ui-price-display.price.simple.selected > div.ui-price-display__main.special-price > span").getText();
                System.out.println("Ціна паперової книги: " + pricePaper);
            }
            Thread.sleep(1000);
            if (digitalBookButton.isDisplayed()) {
                String priceDig = Selenide.$("div.ui-price-display.price.simple:last-of-type > [class=\"ui-price-display__main\"] > span").getText();
